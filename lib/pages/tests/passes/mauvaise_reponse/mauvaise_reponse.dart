...
class MauvaiseReponse extends StatefulWidget {
  const MauvaiseReponse({super.key});

  @override
  State<MauvaiseReponse> createState() => _MauvaiseReponse();
}

class _MauvaiseReponse extends State<MauvaiseReponse>
      ...
      child: SafeArea(
        child: Scaffold(
          appBar: AppBar(
            ...
            title: const Text('Mauvaise reponses'),
            bottom: TabBar(
              isScrollable: true,
